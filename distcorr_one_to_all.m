function dcor = distcorr_one_to_all(x,y)
% copyright MCuperlovicCulf, Ottawa, 2020
% Function calculates the distance correlation between x and y where x and
% y matrices can have different number of columns
